...
<template>
  <n-el>
    ...
    <n-space :size="[200, 0]">
      <div>
        <n-h1 data-sal="slide-up" data-sal-delay="500" data-sal-easing="ease-out-back" data-sal-duration="500">
          <n-text type="primary">
            Try it out!
          </n-text>
        </n-h1>
      ...
      <div>
        ...
        <n-form
          ...
          :rules="rules"
          label-placement="top"
          require-mark-placement="left-hanging"
          :size="size"
          label-width="auto"
          :style="{
            maxWidth: '640px'
        ...
        >
          ...
          <n-form-item label="Date" path="datetimeValue">
